...
func updateNvidiaDevicePlugin() error {
	_, _, gpuStatus := getDevices()
	log.Infof("GPU Status: %v", gpuStatus)
	err := patchGPUStatus(gpuStatus)
	if err != nil {
		check(err)
		return err
	}
...
// 	err = patchGPUMemoryCapacity(GPUMemCapacity)
// 	if err != nil {
// 		return err
// 	}

// 	err = patchGPUMemoryUsed(GPUMemUsed)
// 	if err != nil {
// 		return err
// 	}
// 	return nil
