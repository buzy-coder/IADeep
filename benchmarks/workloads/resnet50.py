...
def train_resnet50(args, model, device, train_loader, test_loader, optimizer, kwargs):
    count = 0
...
if __name__ == "__main__":
    ...
    parser.add_argument('--pod_name', type=str, default="resnet50",
                        help="pod name in kubernetes cluster")
    parser.add_argument('--data_path', type=str, default="/workspace/dataset/cifar100", 
    ...
    parser.add_argument('--valid_acc', type=float, default=0.578, metavar='Acc',
    ...
    etcd_wraper.put(pod_name, "mini_batch_time_m0", "0.1817309856414795")
