...
def run(
    ...
    for batch_i, (im, targets, paths, shapes) in enumerate(pbar):
        ...
        for si, pred in enumerate(out):
            ...
            # if accuracy/100 >= opt.valid_acc and count < opt.patience:
            #     print("accuracy >= opt.valid_acc")
            #     count += 1
            # if count >= opt.patience:
            #     print("break......")
            #     etcd_wraper.put(pod_name, 'complete', "1")
            #     etcd_wraper.put(pod_name, 'epoch_times', epoch)
...
def parse_opt():
    ...
    # parser.add_argument('--valid_acc', type=float, default=0.84, metavar='Acc',
